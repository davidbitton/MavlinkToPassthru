...
void FrSkySPort_Process() {
    ...
    if (!mavGood)
        return; // Wait for good Mavlink data
...
void SendLat800() {
    ...
    Debug.print(" fr_lat=");
    Debug.print(fr_lat);
    Debug.print(" fr_payload=");
    Debug.println(fr_payload);
#endif
...
void SendStatusTextChunk5000() {
    ...
    if (fr_chunk_pntr == 0) {
        ...
        Debug.print(fr_severity);
        Debug.print(" ");
        Debug.print(MavSeverity(fr_severity));
        Debug.print(" Text= ");
        Debug.print(" |");
        Debug.print(fr_text);
        Debug.print("| ");
        Debug.print(" Msg queue length after shift= ");
        Debug.println(MsgRingBuff.size());
#endif
    }
...
#if defined Frs_Debug_All || defined Frs_Debug_Text
        Debug.print(" fr_txtlth=");
        Debug.print(fr_txtlth);
        Debug.print(" fr_chunk_pntr=");
        Debug.print(fr_chunk_pntr);
        Debug.print(" ");
        Debug.print(" |");
...
void SendAP_Status5001() {
    if (ap_type == 6)
        return; // If GCS heartbeat ignore it  -  yaapu  - ejs also handled at #0 read
    ...
    Debug.print(fr_bat_fs);
    Debug.print(" fr_ekf_fs=");
    Debug.print(fr_ekf_fs);
    Debug.print(" px4_flight_stack=");
    Debug.println(px4_flight_stack);
#endif
...
#if defined Frs_Debug_All || defined Frs_Debug_GPS_Status
    Debug.print(" After prep: fr_amsl=");
    Debug.print(fr_amsl);
    Debug.print(" fr_hdop=");
    Debug.println(fr_hdop);
#endif
...
void Send_Bat1_5003() {
    ...
    Debug.print(" fr_bat1_volts=");
    Debug.print(fr_bat1_volts);
    Debug.print(" fr_bat1_amps=");
    Debug.print(fr_bat1_amps);
    Debug.print(" fr_bat1_mAh=");
...
void Send_Home_5004() {
    ...
    Debug.print("fr_home_dist=");
    Debug.print(fr_home_dist);
    Debug.print(" fr_home_alt=");
    Debug.print(fr_home_alt);
    Debug.print(" az=");
    Debug.print(az);
    Debug.print(" fr_home_angle=");
    Debug.print(fr_home_angle);
    Debug.print(" fr_home_arrow=");
    Debug.println(fr_home_arrow); // units of 3 deg
#endif
...
void Send_VelYaw_5005() {
    ...
    Debug.print(" fr_vy=");
    Debug.print((int)fr_vy);
    Debug.print(" fr_vx=");
    Debug.print((int)fr_vx);
    Debug.print(" fr_yaw=");
    Debug.println((int)fr_yaw);
#endif
...
void Send_Atti_5006() {
    ...
    Debug.print("fr_roll=");
    Debug.print(fr_roll);
    Debug.print(" fr_pitch=");
    Debug.print(fr_pitch);
    Debug.print(" fr_range=");
    Debug.print(fr_range);
    Debug.print(" Frs_Attitude Payload=");
    Debug.println(fr_payload);
#endif
...
void SendParameters5007() {
    ...
    case 1: // Frame type
        ...
        Debug.print(" fr_param_id=");
        Debug.print(fr_param_id);
        Debug.print(" fr_frame_type=");
...
#if defined Frs_Debug_All || defined Debug_Batteries
    Debug.print("Frsky out Bat1 0x5003: ");
    Debug.print(" fr_bat2_volts=");
    Debug.print(fr_bat2_volts);
    Debug.print(" fr_bat2_amps=");
    Debug.print(fr_bat2_amps);
    Debug.print(" fr_bat2_mAh=");
...
void SendRssiF101() { // data id 0xF101 RSSI tell LUA script in Taranis we are connected
    ...
    fr_rssi = 87;
    Debug.print(" Dummy rssi=");
    Debug.println(fr_rssi);
#endif
